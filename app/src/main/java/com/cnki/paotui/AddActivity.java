...
public class AddActivity extends BaseActivity{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        minusnum=findViewById(R.id.minusnum);
    ...
    private void  initView() {
        if(order!=null){
            ...
            ed_get.setText(TextUtils.isEmpty(order.startaddress)?"":order.startaddress);
            ed_get.setEnabled(false);
            ed_send.setText(TextUtils.isEmpty(order.endaddress)?"":order.endaddress);
            ed_send.setEnabled(false);
            ed_name.setText(TextUtils.isEmpty(order.name)?"":order.name);
            ed_name.setEnabled(false);
            seekBar.setEnabled(false);
            tv_num.setText(order.num+"");
            tv_weight.setText(order.weight+"");
...
//                            order.orderstate=OrderState.END;
...
//                    });
//                }
//                else if(order.orderstate==OrderState.END){
//                    commit.setText("完成");
...
//                }
            ...
            order.refreshcommit(AddActivity.this,commit,null);
        }else {
...
//    CheckBox checkBox;//
    ...
    private void onCommit(){
        ...
        if(TextUtils.isEmpty(ed_get.getText().toString())||TextUtils.isEmpty(ed_send.getText().toString())){
            Toast.makeText(mContext, "请输入取货和收货地址", Toast.LENGTH_SHORT).show();
            return;
        }
...
//        public int man;//1男 0女
//        public int ordertype; //0 快递  1辅导  3组队
